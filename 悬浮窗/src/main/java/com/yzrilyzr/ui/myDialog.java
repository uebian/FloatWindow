...
{	
	...
	public myDialog(Context c)
	{
		...
		p.weight=1;
		ll.addView(title=new myTextViewTitleBack(c),p);
		p=new LayoutParams(-1,-2);
		...
		LayoutParams lp=new LayoutParams(util.px(55),util.px(40));
		m=util.px(5);
		...
		neg.setTextColor(uidata.UI_COLOR_MAIN);
		neu.setTextColor(uidata.UI_COLOR_MAIN);
		pos.setTextColor(uidata.UI_COLOR_MAIN);
		neg.setBackground(new myRippleDrawable(uidata.UI_COLOR_BACK));
		neu.setBackground(new myRippleDrawable(uidata.UI_COLOR_BACK));
		pos.setBackground(new myRippleDrawable(uidata.UI_COLOR_BACK));
		p=new LayoutParams(-1,-2);
		content.addView(l,p);
	}
	@Override
	protected void onCreate(Bundle savedInstanceState)
	{
        ...
        params.width=(int)(util.getScreenWidth()*0.9);
		params.height=-2;
	...
	public static class Builder
    {
		...
		{
			myTextViewBack t=new myTextViewBack(ctx);
