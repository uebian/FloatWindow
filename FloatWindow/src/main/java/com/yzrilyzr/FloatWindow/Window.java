...
import com.yzrilyzr.FloatWindow.API_APP.ButtonCode;
...
public class Window implements View.OnClickListener,View.OnTouchListener,View.OnLongClickListener
{
    ...
    public Window setInterface(Object i)
    {
        inter=i;
        return this;
    }
    ...
    public boolean onLongClick(View p1)
    {
        ...
        switch(p1.getId())
        {
            case R.id.mainwindowButton1:
                if(inter!=null)API_APP.invoke(inter,"onButtonDown",ButtonCode.FOCUS_LONG);
                break;
            case R.id.mainwindowButton2:
                if(inter!=null)API_APP.invoke(inter,"onButtonDown",ButtonCode.MIN_LONG);
                break;
            case R.id.mainwindowButton3:
                if(inter!=null)API_APP.invoke(inter,"onButtonDown",ButtonCode.MAX_LONG);
                break;
            case R.id.mainwindowButton4:
                if(inter!=null)API_APP.invoke(inter,"onButtonDown",ButtonCode.CLOSE_LONG);
                break;
    ...
    {
        if(inter!=null)API_APP.invoke(inter,"onSizeChanged",w,h,width,height);
        width=w;
        height=h;
        windowParam.width=w;
    ...
    public void onClick(View p1)
    {
        ...
        {
            case R.id.mainwindowButton1:
                if(inter!=null)API_APP.invoke(inter,"onButtonDown",ButtonCode.FOCUS);
                toggleFocusable();
                break;
            case R.id.mainwindowButton2:
                if(inter!=null)API_APP.invoke(inter,"onButtonDown",ButtonCode.MIN);
                toggleMinWin();
                break;
            case R.id.mainwindowButton3:
                if(inter!=null)API_APP.invoke(inter,"onButtonDown",ButtonCode.MAX);
                toggleMaxWin();
                break;
            case R.id.mainwindowButton4:
                if(inter!=null)API_APP.invoke(inter,"onButtonDown",ButtonCode.CLOSE);
                dismiss();
                break;
            case R.id.mainwindowButton5:
                if(inter!=null)API_APP.invoke(inter,"onButtonDown",ButtonCode.MIN);
    ...
    public boolean moveableView(View p1,MotionEvent event)
    {
        switch (event.getAction())
        {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if(inter!=null)API_APP.invoke(inter,"onPositionChanged",windowParam.x,windowParam.y);
                window.updateViewLayout(winView,windowParam);
                break;
            case MotionEvent.ACTION_UP:
