...
public final class util
{
	...
	public static final String mainDir=sdcard+"/yzr的app/悬浮窗";
	static{
		...
		Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler(){
				...
				public void uncaughtException(Thread p1, Throwable p2)
				{
					try
					{
						FileOutputStream os=new FileOutputStream(util.mainDir+"/错误日志.txt");
	...
	public static final void openFile(Context c,File file)
	{  
