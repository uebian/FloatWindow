		...
		protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
			{
				...
				if(!uidata.UI_USESHADOW)setMeasuredDimension(WidgetUtils.measureWidth(widthMeasureSpec,getWidth()),WidgetUtils.measureHeight(heightMeasureSpec,util.dip2px(55)));
				else setMeasuredDimension(WidgetUtils.measureWidth(widthMeasureSpec,getWidth()),WidgetUtils.measureHeight(heightMeasureSpec,util.dip2px(58)));
