...
public class myToolBar extends myLinearLayout implements OnClickListener
{
	...
	public myToolBar(Context c,AttributeSet a)
	{
		...
		int margin=0;
		if(uidata.UI_USESHADOW)margin=util.px(3);
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		if(!uidata.UI_USESHADOW)setMeasuredDimension(WidgetUtils.measure(widthMeasureSpec,getWidth()),WidgetUtils.measure(heightMeasureSpec,util.px(55)+stH));
		else setMeasuredDimension(WidgetUtils.measure(widthMeasureSpec,getWidth()),WidgetUtils.measure(heightMeasureSpec,util.px(58)+stH));
	}
}
